...
const UpdateOutCampusB: React.FC = () => {
  ...
  const handleUpdateProposal = async () => {
    ...
    try {
      const response = await axios.put(`http://localhost:8800/proposals/outcampus-b/update/${pros_key}`, formData, {
...
export default UpdateOutCampusB;