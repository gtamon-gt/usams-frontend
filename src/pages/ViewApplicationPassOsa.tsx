...
const ViewApplicationPassOsa: React.FC = () => {
        ...
        {application && (
          <div className="application-form-box2">
            ...
            <div className="application-form-input-group2">
              <p><span style={{ fontWeight: 500 }}>Name:</span>{application.stud_name} </p>
              <p><span style={{ fontWeight: 500 }}>Student ID:</span> {application.stud_id}</p>
              <p><span style={{ fontWeight: 500 }}>Course & Year:</span>  {application.year_level} </p>
              <p><span style={{ fontWeight: 500 }}>College:</span>  {application.course}</p>
...
export default ViewApplicationPassOsa;
