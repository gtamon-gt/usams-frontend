...
const OutCampusA: React.FC = () => {
  ...
  const handleNewProposal = async () => {
    ...
    try {
      const response = await axios.post(`http://localhost:8800/proposals/outcampus-a/add`, formData, {
      ...
      navigate(`/preview/out-campus-a/${newProsKey}`);
    } catch (err) {
