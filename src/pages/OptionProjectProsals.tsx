...
const OptionProjectProsals: React.FC = () => {
      ...
      <div className="main-content4">
        <div className="update-org-container">
          <div className="options-top">
            <h1 className="organizations-name">Project Proposals Menu</h1>
            <p className="organizations-description">Which proposal form you would like to use?</p>
          </div>
          <div className="option-shortcut-boxes">
            <div className="option-tab">
              <div className="orglist-container">
                <div className="orglist-border shortcutimg">
                  <img src="/in-campus.png" alt="Shortcut 1" />
                </div>
              </div>
              <div className="option-shortcut-text-section">
                <Link
                  className="organizations-links option-shortcut-name"
                  to={`/in-campus/${organization.org_id}`}
                  state={{ userId: userId, userInfo: userInfo }}
                >
                  In-Campus Activity Form
                </Link>
                <p className="organizations-desc option-shortcut-desc">
                  Fill out the In-Campus Activity Form of the Office of Student Affairs if you will conduct activity inside the university.
                </p>
              </div>
            ...
            <div className="option-tab">
              <div className="orglist-container">
                <div className="orglist-border shortcutimg">
                  <img src="/out-campus.png" alt="Shortcut 2" />
                </div>
              </div>
              <div className="option-shortcut-text-section">
                <Link
                  className="organizations-links option-shortcut-name"
                  to={`/out-campus-a/${organization.org_id}`}
                  state={{ userId: userId, userInfo: userInfo }}
                >
                  Off-Campus Activity Form A
                </Link>
                <p className="organizations-desc option-shortcut-desc">
                  Fill out the Off-Campus Activity Form A of the Office of Student Affairs if you will conduct activity outside the university.
                </p>
              </div>
              <img src="/arrow.png" alt="Arrow" className="arrowimg" />
            </div>
            <div className="option-tab">
              <div className="orglist-container">
                <div className="orglist-border shortcutimg">
                  <img src="/out-campus.png" alt="Shortcut 3" />
                </div>
              </div>
              <div className="option-shortcut-text-section">
                <Link
                  className="organizations-links option-shortcut-name"
                  to={`/out-campus-b/${organization.org_id}`}
                  state={{ userId: userId, userInfo: userInfo }}
                >
                  Off-Campus Activity Form B
                </Link>
                <p className="organizations-desc option-shortcut-desc">
                  Fill out the Off-Campus Activity Form B of the Office of Student Affairs if you will conduct activity outside the university.
                </p>
              </div>
              <img src="/arrow.png" alt="Arrow" className="arrowimg" />
            </div>
...
export default OptionProjectProsals;
