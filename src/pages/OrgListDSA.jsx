...
const OrgListDSA = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [usersResponse, organizationsResponse, approversResponse] = await Promise.all([
  ...
  const handleViewClick = (org_id) => {
    navigate(`/org-details-dsa/${org_id}`, { state: { userId } });
  };
            ...
            {filteredOrgs.map(org => (
              <div className="org" key={org.org_id}>
                ...
                <div className="org-view">
                  <button onClick={() => handleViewClick(org.org_id)} className="view-button">View</button>
                </div>
              </div>
            ))}
          </div>
